...
impl W {
    #[doc = "Bit 0 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done0(&mut self) -> Done0W<IfSetSpec> {
        Done0W::new(self, 0)
    }
    #[doc = "Bit 1 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done1(&mut self) -> Done1W<IfSetSpec> {
        Done1W::new(self, 1)
    }
    #[doc = "Bit 2 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done2(&mut self) -> Done2W<IfSetSpec> {
        Done2W::new(self, 2)
    }
    #[doc = "Bit 3 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done3(&mut self) -> Done3W<IfSetSpec> {
        Done3W::new(self, 3)
    }
    #[doc = "Bit 4 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done4(&mut self) -> Done4W<IfSetSpec> {
        Done4W::new(self, 4)
    }
    #[doc = "Bit 5 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done5(&mut self) -> Done5W<IfSetSpec> {
        Done5W::new(self, 5)
    }
    #[doc = "Bit 6 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done6(&mut self) -> Done6W<IfSetSpec> {
        Done6W::new(self, 6)
    }
    #[doc = "Bit 7 - DMA Structure Operation Done"]
    #[inline(always)]
    pub fn done7(&mut self) -> Done7W<IfSetSpec> {
        Done7W::new(self, 7)
    }
    #[doc = "Bit 31 - Error Flag"]
    #[inline(always)]
    pub fn error(&mut self) -> ErrorW<IfSetSpec> {
        ErrorW::new(self, 31)
    }
}
