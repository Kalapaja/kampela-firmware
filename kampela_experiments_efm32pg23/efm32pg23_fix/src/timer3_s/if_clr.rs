...
impl W {
    #[doc = "Bit 0 - Overflow Interrupt Flag"]
    #[inline(always)]
    pub fn of(&mut self) -> OfW<IfClrSpec> {
        OfW::new(self, 0)
    }
    #[doc = "Bit 1 - Underflow Interrupt Flag"]
    #[inline(always)]
    pub fn uf(&mut self) -> UfW<IfClrSpec> {
        UfW::new(self, 1)
    }
    #[doc = "Bit 2 - Direction Change Detect Interrupt Flag"]
    #[inline(always)]
    pub fn dirchg(&mut self) -> DirchgW<IfClrSpec> {
        DirchgW::new(self, 2)
    }
    #[doc = "Bit 4 - Capture Compare Channel 0 Interrupt Flag"]
    #[inline(always)]
    pub fn cc0(&mut self) -> Cc0W<IfClrSpec> {
        Cc0W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture Compare Channel 1 Interrupt Flag"]
    #[inline(always)]
    pub fn cc1(&mut self) -> Cc1W<IfClrSpec> {
        Cc1W::new(self, 5)
    }
    #[doc = "Bit 6 - Capture Compare Channel 2 Interrupt Flag"]
    #[inline(always)]
    pub fn cc2(&mut self) -> Cc2W<IfClrSpec> {
        Cc2W::new(self, 6)
    }
    #[doc = "Bit 16 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull0(&mut self) -> Icfwlfull0W<IfClrSpec> {
        Icfwlfull0W::new(self, 16)
    }
    #[doc = "Bit 17 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull1(&mut self) -> Icfwlfull1W<IfClrSpec> {
        Icfwlfull1W::new(self, 17)
    }
    #[doc = "Bit 18 - Input Capture Watermark Level Full"]
    #[inline(always)]
    pub fn icfwlfull2(&mut self) -> Icfwlfull2W<IfClrSpec> {
        Icfwlfull2W::new(self, 18)
    }
    #[doc = "Bit 20 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof0(&mut self) -> Icfof0W<IfClrSpec> {
        Icfof0W::new(self, 20)
    }
    #[doc = "Bit 21 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof1(&mut self) -> Icfof1W<IfClrSpec> {
        Icfof1W::new(self, 21)
    }
    #[doc = "Bit 22 - Input Capture FIFO overflow"]
    #[inline(always)]
    pub fn icfof2(&mut self) -> Icfof2W<IfClrSpec> {
        Icfof2W::new(self, 22)
    }
    #[doc = "Bit 24 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf0(&mut self) -> Icfuf0W<IfClrSpec> {
        Icfuf0W::new(self, 24)
    }
    #[doc = "Bit 25 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf1(&mut self) -> Icfuf1W<IfClrSpec> {
        Icfuf1W::new(self, 25)
    }
    #[doc = "Bit 26 - Input capture FIFO underflow"]
    #[inline(always)]
    pub fn icfuf2(&mut self) -> Icfuf2W<IfClrSpec> {
        Icfuf2W::new(self, 26)
    }
}
