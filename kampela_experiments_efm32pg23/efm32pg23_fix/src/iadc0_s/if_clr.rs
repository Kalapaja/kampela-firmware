#[doc = "Register `IF_CLR` reader"]
pub type R = crate::R<IfClrSpec>;
...
impl W {
    #[doc = "Bit 0 - Single FIFO Data Valid Level"]
    #[inline(always)]
    pub fn singlefifodvl(&mut self) -> SinglefifodvlW<IfClrSpec> {
        SinglefifodvlW::new(self, 0)
    }
    #[doc = "Bit 1 - Scan FIFO Data Valid Level"]
    #[inline(always)]
    pub fn scanfifodvl(&mut self) -> ScanfifodvlW<IfClrSpec> {
        ScanfifodvlW::new(self, 1)
    }
    #[doc = "Bit 2 - Single Result Window Compare"]
    #[inline(always)]
    pub fn singlecmp(&mut self) -> SinglecmpW<IfClrSpec> {
        SinglecmpW::new(self, 2)
    }
    #[doc = "Bit 3 - Scan Result Window Compare"]
    #[inline(always)]
    pub fn scancmp(&mut self) -> ScancmpW<IfClrSpec> {
        ScancmpW::new(self, 3)
    }
    #[doc = "Bit 7 - Scan Entry Done"]
    #[inline(always)]
    pub fn scanentrydone(&mut self) -> ScanentrydoneW<IfClrSpec> {
        ScanentrydoneW::new(self, 7)
    }
    #[doc = "Bit 8 - Scan Table Done"]
    #[inline(always)]
    pub fn scantabledone(&mut self) -> ScantabledoneW<IfClrSpec> {
        ScantabledoneW::new(self, 8)
    }
    #[doc = "Bit 9 - Single Conversion Done"]
    #[inline(always)]
    pub fn singledone(&mut self) -> SingledoneW<IfClrSpec> {
        SingledoneW::new(self, 9)
    }
    #[doc = "Bit 12 - Polarity Error"]
    #[inline(always)]
    pub fn polarityerr(&mut self) -> PolarityerrW<IfClrSpec> {
        PolarityerrW::new(self, 12)
    }
    #[doc = "Bit 13 - Port Allocation Error"]
    #[inline(always)]
    pub fn portallocerr(&mut self) -> PortallocerrW<IfClrSpec> {
        PortallocerrW::new(self, 13)
    }
    #[doc = "Bit 16 - Single FIFO Overflow"]
    #[inline(always)]
    pub fn singlefifoof(&mut self) -> SinglefifoofW<IfClrSpec> {
        SinglefifoofW::new(self, 16)
    }
    #[doc = "Bit 17 - Scan FIFO Overflow"]
    #[inline(always)]
    pub fn scanfifoof(&mut self) -> ScanfifoofW<IfClrSpec> {
        ScanfifoofW::new(self, 17)
    }
    #[doc = "Bit 18 - Single FIFO Underflow"]
    #[inline(always)]
    pub fn singlefifouf(&mut self) -> SinglefifoufW<IfClrSpec> {
        SinglefifoufW::new(self, 18)
    }
    #[doc = "Bit 19 - Scan FIFO Underflow"]
    #[inline(always)]
    pub fn scanfifouf(&mut self) -> ScanfifoufW<IfClrSpec> {
        ScanfifoufW::new(self, 19)
    }
    #[doc = "Bit 31 - EM2/3 Abort Error"]
    #[inline(always)]
    pub fn em23aborterror(&mut self) -> Em23aborterrorW<IfClrSpec> {
        Em23aborterrorW::new(self, 31)
    }
}
#[doc = "Interrupt Flag\n\nYou can [`read`](crate::Reg::read) this register and get [`if_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`if_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IfClrSpec;
impl crate::RegisterSpec for IfClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`if_clr::R`](R) reader structure"]
impl crate::Readable for IfClrSpec {}
