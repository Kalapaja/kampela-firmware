...
impl W {
    #[doc = "Bit 0 - TX Complete Interrupt Flag"]
    #[inline(always)]
    pub fn txc(&mut self) -> TxcW<IfClrSpec> {
        TxcW::new(self, 0)
    }
    #[doc = "Bit 1 - TX Buffer Level Interrupt Flag"]
    #[inline(always)]
    pub fn txbl(&mut self) -> TxblW<IfClrSpec> {
        TxblW::new(self, 1)
    }
    #[doc = "Bit 2 - RX Data Valid Interrupt Flag"]
    #[inline(always)]
    pub fn rxdatav(&mut self) -> RxdatavW<IfClrSpec> {
        RxdatavW::new(self, 2)
    }
    #[doc = "Bit 3 - RX Buffer Full Interrupt Flag"]
    #[inline(always)]
    pub fn rxfull(&mut self) -> RxfullW<IfClrSpec> {
        RxfullW::new(self, 3)
    }
    #[doc = "Bit 4 - RX Overflow Interrupt Flag"]
    #[inline(always)]
    pub fn rxof(&mut self) -> RxofW<IfClrSpec> {
        RxofW::new(self, 4)
    }
    #[doc = "Bit 5 - RX Underflow Interrupt Flag"]
    #[inline(always)]
    pub fn rxuf(&mut self) -> RxufW<IfClrSpec> {
        RxufW::new(self, 5)
    }
    #[doc = "Bit 6 - TX Overflow Interrupt Flag"]
    #[inline(always)]
    pub fn txof(&mut self) -> TxofW<IfClrSpec> {
        TxofW::new(self, 6)
    }
    #[doc = "Bit 7 - TX Underflow Interrupt Flag"]
    #[inline(always)]
    pub fn txuf(&mut self) -> TxufW<IfClrSpec> {
        TxufW::new(self, 7)
    }
    #[doc = "Bit 8 - Parity Error Interrupt Flag"]
    #[inline(always)]
    pub fn perr(&mut self) -> PerrW<IfClrSpec> {
        PerrW::new(self, 8)
    }
    #[doc = "Bit 9 - Framing Error Interrupt Flag"]
    #[inline(always)]
    pub fn ferr(&mut self) -> FerrW<IfClrSpec> {
        FerrW::new(self, 9)
    }
    #[doc = "Bit 10 - Multi-Processor Address Frame Interrupt"]
    #[inline(always)]
    pub fn mpaf(&mut self) -> MpafW<IfClrSpec> {
        MpafW::new(self, 10)
    }
    #[doc = "Bit 11 - Chip-Select In Main Mode Interrupt Flag"]
    #[inline(always)]
    pub fn ssm(&mut self) -> SsmW<IfClrSpec> {
        SsmW::new(self, 11)
    }
    #[doc = "Bit 12 - Collision Check Fail Interrupt Flag"]
    #[inline(always)]
    pub fn ccf(&mut self) -> CcfW<IfClrSpec> {
        CcfW::new(self, 12)
    }
    #[doc = "Bit 13 - TX Idle Interrupt Flag"]
    #[inline(always)]
    pub fn txidle(&mut self) -> TxidleW<IfClrSpec> {
        TxidleW::new(self, 13)
    }
    #[doc = "Bit 14 - Timer comparator 0 Interrupt Flag"]
    #[inline(always)]
    pub fn tcmp0(&mut self) -> Tcmp0W<IfClrSpec> {
        Tcmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Timer comparator 1 Interrupt Flag"]
    #[inline(always)]
    pub fn tcmp1(&mut self) -> Tcmp1W<IfClrSpec> {
        Tcmp1W::new(self, 15)
    }
    #[doc = "Bit 16 - Timer comparator 2 Interrupt Flag"]
    #[inline(always)]
    pub fn tcmp2(&mut self) -> Tcmp2W<IfClrSpec> {
        Tcmp2W::new(self, 16)
    }
}
...
#[doc = "`reset()` method sets IF_CLR to value 0x02"]
